...
class RatingView: UIView {
    ...
    let searchTextfield: UITextField = {
        ...
        textfield.attributedPlaceholder = NSAttributedString(string: "Поиск по имени или магазину", attributes: [NSAttributedString.Key.foregroundColor: UIColor(red: 0.475, green: 0.475, blue: 0.478, alpha: 1)])
        return textfield
    }()
